...
void logGameState(uintptr_t* time, uintptr_t* p1, uintptr_t* p2, uintptr_t* XScreenScroll1, uintptr_t* XScreenScroll2, uintptr_t* YScreenScroll1, uintptr_t* YScreenScroll2, uintptr_t* objectData[])
{
	...
	fprintf(g_oFile, ("X Screen Scroll 1 Address: " + uint_to_hex((unsigned int)XScreenScroll1) + " Value: " + std::to_string(*XScreenScroll1) + "\n").c_str());
	fprintf(g_oFile, ("X Screen Scroll 2 Address: " + uint_to_hex((unsigned int)XScreenScroll2) + " Value: " + std::to_string(*XScreenScroll2) + "\n").c_str());
	fprintf(g_oFile, ("Y Screen Scroll 1 Address: " + uint_to_hex((unsigned int)YScreenScroll1) + " Value: " + std::to_string(*YScreenScroll1) + "\n").c_str());
	fprintf(g_oFile, ("Y Screen Scroll 2 Address: " + uint_to_hex((unsigned int)YScreenScroll2) + " Value: " + std::to_string(*YScreenScroll2) + "\n").c_str());
	fflush(g_oFile);
}
